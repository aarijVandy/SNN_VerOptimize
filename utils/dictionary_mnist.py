...
location = '.'
image_len = 28
n_layer_neurons = (image_len*image_len, 14, 10) # [28*28, 100, 10] default
...
TSpike = dict[Node_Layer_Time, Union[BoolRef, bool]]
...
TWeightShape = Union[tuple[Literal[400], Literal[28], Literal[28]], tuple[Literal[10], Literal[400], Literal[1]]]
